...
**Tag status:** `v1.0.0` is not cut. This sheet sits beside the empty
screenshot and coverage scaffold in [README.md](README.md) on the same
pre-tag folder ([pull request #230](https://github.com/CMSC495-GROUP3/Sourcebook/pull/230)).
Do not treat Pending rows as final release claims.
...
| Final smoke / full evaluation | Pending — requires [issue #215](https://github.com/CMSC495-GROUP3/Sourcebook/issues/215) `v1.0.0` freeze artifacts after the tag | [pull request #230](https://github.com/CMSC495-GROUP3/Sourcebook/pull/230) scaffolds the folder; this sheet's Pending cells are not a PASS |
